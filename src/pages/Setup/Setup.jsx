  ...
  return (
    <div className='biolink-setup'>
      <div className='biolink-setup__container'>
        <div className='biolink-setup__main'>
          <div className='biolink-setup__edit'>
            <div className='biolink-setup__edit-head'>
            ...
            <div className='biolink-setup__edit-main-container'>
              {!dashboardOn ? (
                <div className='biolink-setup__edit-main-data'>
                  <img
                    src='https://i.pinimg.com/originals/8a/a4/59/8aa4595fb24b6ed585dddac4622b2445.gif'
                    alt='hi gif'
                  />
                  <h2>Welcome to Usebiolink!</h2>
                  <p>
                    Let's get you started. We'll walk you through the process of
                    creating your first bio link. It will only take a few
                    minutes.
                  </p>
                  <button className='btn biolink-button ' onClick={startButton}>
                    Let's start
                  </button>
                </div>
          ...
          <div className='biolink-setup__display'>display</div>
        </div>
      </div>
    </div>
  )
